...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_USER_TABLE = "create table userTABLE" + "(_id integer primary key," +
            "Food text, Source text, Price text);";
    private static final String CREATE_ORDER_TABLE = "create table orderTABLE" +"(_id integer primary key," +
            "officer text, Desk text, Food text, Item text);";
